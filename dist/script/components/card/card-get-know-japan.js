...
class CardGetKnowJapan extends HTMLElement {
    ...
    render() {
      this.innerHTML = `
      <div class="relative h-[421px] select-none" id="card">
          <div
          ...
          >
          <div
              class="flex -translate-y-0 flex-col items-center transition-all duration-200"
              id="cardArrowContainer"
          >
          <p class="text-lg sm:text-2xl xl:text-3xl font-medium">${this.getAttribute("title")}</p>
              <svg
